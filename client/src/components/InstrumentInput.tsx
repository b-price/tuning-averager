...
const InstrumentInput: React.FC<InstrumentInputProps> = ({
    ...
    const handleTuningsButtonClick = () => {
    ...
    useEffect(() => {
        const handleClickOutside = (event: MouseEvent) => {
            if (dropdownRef.current && !dropdownRef.current.contains(event.target as Node)) {
                if (event.target && (event.target as HTMLElement).id !== "tunings-button"){
                    setIsTuningDropdownOpen(false);
                }
            }
        };
                ...
                <div className="grid sm:grid-cols-2 grid-cols-1 gap-4">
                    ...
                    <div className="space-y-2 mx-2">
                        ...
                        <div className="relative">
                            <button
                                id="tunings-button"
                                onClick={handleTuningsButtonClick}
                                className="w-full mt-2 px-4 py-2 text-white bg-blue-500 rounded-md hover:bg-blue-400"
                            >
                            Select Tunings
                            </button>
                                ...
                                <div ref={dropdownRef}
                                    className={isTuningDropdownOpen
